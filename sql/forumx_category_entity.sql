...
CREATE TABLE `category_entity` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_m8v0jimr4j85cle39vo2x93ys` (`name`)
...
INSERT INTO `category_entity` VALUES (1,'string','UCL',0),(2,'All about UET','UET',3),(3,'All about Frontend','Frontend',0),(4,'All about Backend','Backend',0),(5,'All about EPL','EPL',0);
